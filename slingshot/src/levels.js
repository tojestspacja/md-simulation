...
//
// Fields:
//   id           permanent identity, independent of position in this array.
//                Chosen by hand, never derived from the name, and immutable
//                once shipped: saved progress will be keyed on it, so renaming
//                one silently orphans a player's record of that level. Adding
//                levels or reordering these is free; editing an id is not.
//   name         what the player sees — free to reword, unlike the id
...
export const LEVELS = [
  { id: "push", name: "the push", hint: "pull back from the probe, then let go",
